...
public class JShellBot implements Daemon {
    private static final String token = "NDE1OTg5MTkwNTAxNTk3MTg1.DW-AVw.UTxuk2AKucDB1aGwPU3XLAPOPeg"; //todo remove to pull from daemon call or properties file
    ...
    public void start() throws Exception {
        ...
        IDiscordClient client = BotUtils.buildDiscordClient(token);
